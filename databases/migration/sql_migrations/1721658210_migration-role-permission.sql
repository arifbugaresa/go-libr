...
insert into permissions (name, module, access_code, grant_code) values
    ('Permission Read Book', 'book', 'book', 'r'),
    ('Permission Update Book', 'book', 'book', 'u'),
    ('Permission Delete Book', 'book', 'book', 'd'),
    ('Permission Create Book', 'book', 'book', 'c');
...
INSERT INTO role_permissions (role_id, permission_id) VALUES ((select id from roles where name = 'Role Admin'),(select id from permissions where name = 'Permission Create Book'));
